...
export function emailForgotPassword(params: { email: string; password: string }) {
    return `
    <!doctype html>
    <html>
      <body style="margin: 0; padding: 24px; background: #f3f4f6; font-family: Arial, Helvetica, sans-serif;">
          ...
          <tr>
            <td align="center">
              ...
              >
                <tr>
                  <td style="padding: 28px;">
                    <h1 style="margin: 0 0 14px 0; font-size: 24px; line-height: 1.35; color: #111827;">Xin chào, ${params.email}!</h1>
                    <p style="margin: 0 0 24px 0; font-size: 14px; line-height: 1.75; color: #374151;">
                      Mật khẩu mới của bạn là: <strong>${params.password}</strong>. Vui lòng đăng nhập để sử dụng.
                    </p>
                  </td>
                </tr>
              </table>
